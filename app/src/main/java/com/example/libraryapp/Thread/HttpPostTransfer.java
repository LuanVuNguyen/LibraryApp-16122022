...
public class HttpPostTransfer  extends AsyncTask<String, String, String> {
     ...
     */
    public HttpPostTransfer(Context c) {
        ...
        try {
            switch (params[0]) {
                case Config.CODE_LOGIN:
                    ...
                    jsonObject.put("Operation Type", new JSONArray(params[2]));
                    jsonObject.put("Contact", new JSONArray(params[3]));
                    jsonObject.put("Source Location", new JSONArray(params[4]));
                    jsonObject.put("Destination Location", new JSONArray(params[5]));
                    jsonObject.put("Source Document", new JSONArray(params[6]));
                    jsonObject.put("rfid", new JSONArray(params[7]));
                    break;
                default:
                    break;
            }
